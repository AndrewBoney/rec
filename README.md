...
This repository is designed to help address that gap by providing a **complete, end-to-end recommendation system**, covering data preparation, training, and deployment in a single, coherent and reproducable repository.
...
- An exhaustive survey or implementation of all recommendation approaches. The focus here is deliberately narrow, primarily on **encoder based neural network architectures**.
